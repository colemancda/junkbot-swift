...
/// a texture or approximated by a single bottom seam. Ported from
/// `tools/Junkbot3D/Sources/Junkbot3D/EdgeOutline.swift`.
enum Scene3DEdgeOutline {
  ...
  private static func lineNode(vertices: [SCNVector3], edges: [(Int32, Int32)]) -> SCNNode {
    ...
    material.diffuse.contents = Scene3DPalette.PlatformColor.black
