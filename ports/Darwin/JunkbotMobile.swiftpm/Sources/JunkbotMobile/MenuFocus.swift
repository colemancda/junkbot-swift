...
@GameActor var focusedButtonIndex: Int?

@GameActor func moveFocus(_ delta: Int) {
...
@GameActor func directionPressed(dx: Int32, dy: Int32, menuDelta: Int) {
...
@GameActor func nudgeDrag(dx: Int32, dy: Int32) {
...
@GameActor func activatePressed() {
...
@GameActor func activateReleased() {
