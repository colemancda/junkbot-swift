// Build-time level converter for the Nintendo 3DS port.
//
// The 3DS binary doesn't parse level text at runtime (the text parser needs
...
// emits the resulting entity lists as generated Swift, which the 3DS build
...
var output = """
  // Generated by ports/3DS/tools/LevelDump - do not edit.
  //
