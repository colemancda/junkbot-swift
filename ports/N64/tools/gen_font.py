#!/usr/bin/env python3
"""Build-time bitmap-font converter for the Nintendo N64 port's HUD overlay.
...
stdlib's grapheme-breaking/case-mapping data tables, which - as
`Sources/JunkbotCore/Level.swift`'s and this port's own `Makefile` notes
explain - cost ~800KB none of this port's ROM budget can spare. Every string
this port actually draws (level titles/hints, both baked into
...
def main():
    ...
    (out_dir / "FontAssets.swift").write_text(
        "// Generated by ports/N64/tools/gen_font.py - do not edit.\n"
        "\n"
