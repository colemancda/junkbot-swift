#!/usr/bin/env python3
"""Build-time audio converter for the Nintendo N64 port.
...
signed 8-bit PCM, mono, at the source's native sample rate --
source/Audio.swift's software mixer resamples each clip to the output rate
on the fly, so no runtime Vorbis/WAV decoder is needed on-device.
...
def main():
    ...
    (out_dir / "AudioAssets.swift").write_text(
        "// Generated by ports/N64/tools/gen_audio.py - do not edit.\n"
        "\n"
