...
class BehaviorTooltip: LingoObject, @unchecked Sendable {
  ...
  // Original Lingo body: checkstatus
  // ```lingo
  // on CheckStatus me
  ...
  // Original Lingo body: getdisplaysprite
  // ```lingo
  ...
  // Original Lingo body: tooltip_setmessage
  // ```lingo
  ...
  // Original Lingo body: tooltip_getreference
  // ```lingo
  ...
  func errorAlert(theError: String) {
    ...
    case "noValidSprites":
      debugLog(
        "BEHAVIOR ERROR: No sprites responded to a DisplayText call. Please ensure that the 'Display Text' behavior is attached to a Field or Text Sprite."
      )
    default:
      break
    }
